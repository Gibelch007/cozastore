...
namespace Cozastore.Controllers
{
    public class CategoriasController : Controller
    {
        ...
        {
            var appDbContext = _context.Categoria.Include(c => c.CategoriaPai);
        ...
        {
            ViewData["CategoriaPaiId"] = new SelectList(_context.Categoria, "Id", "Nome");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Foto,Filtrar,Banner,CategoriaPaiId")] Categoria categoria)
        {
            ...
            ViewData["CategoriaPaiId"] = new SelectList(_context.Categoria, "Id", "Nome", categoria.CategoriaPaiId);
            return View(categoria);
        }
